 ...
 * @LastEditors: Hatrix
 * @LastEditTime: 2024-07-22 19:49:53
 */
...
float FuzzyPID_Calc(FuzzyPID_TypeDef* fuzzy_pid)
{
    ...
    fuzzy_pid->kp = DeFuzzy(fuzzy_pid->kp_rule, fuzzy_pid->kp_set, &(fuzzy_pid->error_range), &(fuzzy_pid->error_change_range), Error, fuzzy_pid->derror);
    fuzzy_pid->ki = DeFuzzy(fuzzy_pid->ki_rule, fuzzy_pid->ki_set, &(fuzzy_pid->error_range), &(fuzzy_pid->error_change_range), Error, fuzzy_pid->derror);
    fuzzy_pid->kd = DeFuzzy(fuzzy_pid->kd_rule, fuzzy_pid->kd_set, &(fuzzy_pid->error_range), &(fuzzy_pid->error_change_range), Error, fuzzy_pid->derror);
