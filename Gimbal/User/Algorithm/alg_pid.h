...
#include "lib_filter.h"
    ...
    typedef struct
    {
        ...
        Filter_Lowpass_TypeDef kf3_filter;
    ...
    void PID_Init(PID_TypeDef *pid, PID_ModeEnum mode,
                  float kp, float ki, float kd, float kf_1, float kf_2, float kf_3, 
                  float sum_max, float output_max, float kd_filter, float kf1_filter, float kf2_filter, float kf3_filter);
