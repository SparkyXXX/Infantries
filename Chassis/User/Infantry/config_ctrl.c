 ...
 * @LastEditors: Hatrix
 * @LastEditTime: 2024-07-16 21:48:24
 */
// WHITE MISTRESS
...
void GimbalYaw_ParamInit(void)
{
    ...
    PID_Init(&(gimbalyaw->spd_no_auto), 15000.0f, 8000.0f, 0.0f, 200000.0f, 12000.0f, 25000.0f, 100000.0f, 159.154922f);
    PID_Init(&(gimbalyaw->pos_no_auto), 14.5f, 20.0f, 0.0f, 0.0f, 0.08f, 9.0f, 500.0f, 159.154922f);
    //                                   kp        ki        kd      kf       sum_max  output_max   d_frq     kf_frq
    PID_Init(&(gimbalyaw->spd_armor), 15000.0f, 8000.0f, 0.0f, 200000.0f, 12000.0f, 25000.0f, 100000.0f, 159.154922f);
    PID_Init(&(gimbalyaw->pos_armor), 14.5f, 20.0f, 0.0f, 0.0f, 0.08f, 9.0f, 500.0f, 159.154922f);
    //                                   kp        ki        kd      kf       sum_max  output_max   d_frq     kf_frq
