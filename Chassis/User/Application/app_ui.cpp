...
#include "util_uart.h"
#include "cmsis_os.h"
constexpr uint16_t CircleX = 960;
...
UI ::Rectangle getTargetRec{
	UI::Color::Pink, 5, {960 - 140, 540 - 140}, {960 + 140, 540 + 140}};
...
UI::Circle DirectionCircle{
	UI::Color::Cyan, 3, {CircleX, CircleY}, Radius};

UI::Line DirectionLine1{
	UI::Color::Green, 4, {CircleX, CircleY}, {CircleX + 30, CircleY + 30}};

/* 实时更新的图层 */

UI::Layer modeLayer{
	"MD", 8, {&shooterRec, &flyRec, &autoAimRec, &capRec, &homeWarningRec, &getTargetRec, &DirectionLine1}};
...
void UI_Update()
{
	...
	if (ui->fly_state)
	{
		flyRec.changeColor(UI::Color::Green);
	}
	else
	{
		flyRec.changeColor(UI::Color::Pink);
	}
	if (ui->is_get_target)
	{
