...
UI::Float pitchValue{
	UI::Color::Green, 2, {960 + 50, 540 + 8}, 20, 1.23456f};
...
UI::Line frontSightMiddle{
	UI::Color::Cyan, 1, {960, 690}, {960, 390}};

UI::Line frontSightUp1{
	UI::Color::Cyan, 1, {885, 690}, {1035, 690}};

UI::Line frontSightUp2{
	UI::Color::Cyan, 1, {910, 640}, {1010, 640}};

UI::Line frontSightUp3{
	UI::Color::Cyan, 1, {935, 590}, {985, 590}};

UI::Line frontSightUp4{
	UI::Color::Cyan, 1, {945, 665}, {975, 665}};

UI::Line frontSightUp5{
	UI::Color::Cyan, 1, {945, 615}, {975, 615}};

UI::Line frontSightDown1{
	UI::Color::Cyan, 1, {885, 390}, {1035, 390}};

UI::Line frontSightDown2{
	UI::Color::Cyan, 1, {910, 440}, {1010, 440}};

UI::Line frontSightDown3{
	UI::Color::Cyan, 1, {935, 490}, {985, 490}};

UI::Line frontSightDown4{
	UI::Color::Cyan, 1, {945, 415}, {975, 415}};

UI::Line frontSightDown5{
	UI::Color::Cyan, 1, {945, 465}, {975, 465}};
...
void UI_Update()
{
	...
	ui->cap_mode = boardcom->cap_mode_user;
	...
	else if (ui->flyslope_flag == POWER_LIMIT && ui->cap_mode == SUPERCAP_CTRL_ON)
	{
		capRec.changeColor(UI::Color::Green);
	}
	else if (ui->flyslope_flag == POWER_LIMIT && ui->cap_mode == SUPERCAP_CTRL_OFF)
	{
	...
	{
		chassisModeString.changeColor(UI::Color::Pink);
