...
uint8_t Kd_RuleList[7][7] = {
    {ZO, NS, NB, NB, NB, NM, PS},
    {PS, PS, NB, NM, NM, NS, ZO},
    {ZO, NS, PM, NM, NS, NS, ZO},
    {ZO, NS, NS, PB, NS, NS, ZO},
    {ZO, ZO, ZO, ZO, NM, ZO, ZO},
    {PB, NS, PS, PS, PS, NS, PB},
    {PB, PM, PM, PM, PS, PS, ZO}};
...
void FuzzyPID_Init(FuzzyPID_TypeDef *fuzzy_pid,
				   ...
				   float sum_max, float output_max, float d_cutoff_frq)
{
